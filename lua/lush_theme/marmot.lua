...
local c = require("lush_theme.marmot_colors").colors
local italic = require("lush_theme.marmot_colors").italic
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    LineNr         { fg = c.grey_4, bg = c.dark_bg_trans }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    ...
    Normal         { bg = c.dark_bg_trans, fg = c.dark_fg_256mod }, -- Normal text
    NormalFloat    { bg = c.dark_bg_trans, fg = c.dark_fg_256mod }, -- Normal text in floating windows.
    FloatBorder    { bg = c.dark_bg_trans, fg = c.dark_fg_256mod }, -- Border of floating windows.
    ...
    Todo           { fg = c.grey_3, gui = italic }, -- Anything that needs extra attention; mostly the keywords TODO FIXME and XXX
